<x-app-layout>
    <x-slot name="header">Edit Data Keluarga</x-slot>
                ...
                <div class="form-card">
                    ...
                    <div class="card-body">
                        <textarea name="keterangan" class="form-control" rows="3"
                                  placeholder="Keterangan tambahan...">{{ $keluarga->keterangan }}</textarea>
                    </div>
                </div>
                            ...
                            <div class="col-6">
                                <label class="check-item">
                                    <input type="checkbox" name="sehat_layak_huni" value="1"
                                           {{ $keluarga->sehat_layak_huni ? 'checked' : '' }}>
                            ...
                            <div class="col-6">
                                <label class="check-item">
                                    <input type="checkbox" name="tidak_layak_huni" value="1"
                                           {{ $keluarga->tidak_layak_huni ? 'checked' : '' }}>
                            ...
                            <div class="col-6">
                                <label class="check-item">
                                    <input type="checkbox" name="tempat_sampah" value="1"
                                           {{ $keluarga->tempat_sampah ? 'checked' : '' }}>
                            ...
                            <div class="col-6">
                                <label class="check-item">
                                    <input type="checkbox" name="industri_rumah_tangga" value="1"
                                           {{ $keluarga->industri_rumah_tangga ? 'checked' : '' }}>
